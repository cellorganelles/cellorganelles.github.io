const characters = [
    ...
    */
    ...
    },
    {
        ...
        desc: "A chill, laid-back guy. He sometimes acts a little shady though.<br><br>Twins with Lumen, but he's slightly younger. He's also the older brother of Gigi.",
    ...
    },
    {
        ...
        desc: "A clumsy guy. He's always full of confidence and likes taking risks. Thanks to Cecilia, he<br><br>He's close friends with Cecilia.",
        jobs: "steers cell",
    ...
    },
    {
        ...
        info: "placeholer<br><br><br>Luke's name comes from the word “nucleus” since it sounds similar. I picked this name partly because of the Percy Jackson series (no, this Luke is not evil). Coincidentially, his brother's name also comes from a Rick Riordan book.",
    },
    {
        name: "Lumen",
        organelle: "Rough ER",
        quote: "Hm? You're not a ribro… Do you need something?",
        desc: "An earnest young lady. On the surface, she looks pretty serious, but she's actually very empathetic and kind (though not to Cistern). Though sometimes, she can get really stressed out…<br><br>Twins with Cistern, but she's slightly older. She's also the older sister of Gigi.",
        jobs: "She makes amino in a factory connected to the main office. Ribros flock to her since they need the amino to build proteins. Because of this, they tend to cling around her station.",
